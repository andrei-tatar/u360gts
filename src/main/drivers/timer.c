...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    {TIM8, GPIOB, Pin_8, TIM_Channel_2, TIM8_CC_IRQn, 1, Mode_AF_PP, GPIO_PinSource8, GPIO_AF_10},           // PWM1 - PB8
    {TIM8, GPIOB, Pin_9, TIM_Channel_3, TIM8_CC_IRQn, 1, Mode_AF_PP, GPIO_PinSource9, GPIO_AF_10},           // PWM2 - PB9
    {TIM2, GPIOA, Pin_3, TIM_Channel_4, TIM2_IRQn, 1, Mode_AF_PP, GPIO_PinSource3, GPIO_AF_1},            // PWM3 - PA3
    {TIM15, GPIOA, Pin_2, TIM_Channel_1, TIM1_BRK_TIM15_IRQn, 1, Mode_AF_PP, GPIO_PinSource2, GPIO_AF_9}, // PWM4 - PA2
    {TIM4, GPIOB, Pin_7, TIM_Channel_2, TIM4_IRQn, 1, Mode_AF_PP, GPIO_PinSource7, GPIO_AF_2},            // PWM7 - PB7
    {TIM4, GPIOB, Pin_6, TIM_Channel_1, TIM4_IRQn, 1, Mode_AF_PP, GPIO_PinSource6, GPIO_AF_2},            // PWM8 - PB6
    {TIM1, GPIOA, Pin_8, TIM_Channel_1, TIM1_CC_IRQn, 1, Mode_AF_PP, GPIO_PinSource8, GPIO_AF_6},         // GPIO_TIMER / LED_STRIP
};
